...
object ArticlesRepository {
    ...
    fun searchBookmarks(searchQuery: String): ArticlesDataFactory {
        return ArticlesDataFactory(ArticleStrategy.SearchBookmark(::searchBookmarks, searchQuery))
    }
    ...
    private fun searchBookmarks(start: Int, size: Int, query: String) = local.localArticleItems
            .asSequence()
            .filter { it.isBookmark }
...
class ArticleDataSource(val strategy: ArticleStrategy): PositionalDataSource<ArticleItemData>() {
    ...
    override fun loadInitial(
        ...
        val result: List<ArticleItemData> = strategy.getItems(params.requestedStartPosition, params.requestedLoadSize)
    ...
    override fun loadRange(
            ...
            callback: LoadRangeCallback<ArticleItemData>
    ) {
