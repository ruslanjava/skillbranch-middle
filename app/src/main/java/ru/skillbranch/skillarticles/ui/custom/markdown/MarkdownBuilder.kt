...
class MarkdownBuilder(context: Context) {
    ...
    val colorSecondary = context.attrValue(R.attr.colorSecondary)
    val colorOnSurface = context.attrValue(R.attr.colorOnSurface)
    val opacityColorSurface = context.getColor(R.color.opacity_color_surface)

    val gap: Float = context.dpToPx(8)
    val strikeWidth = context.dpToPx(4)
    ...
    val linkIcon = context.getDrawable(R.drawable.ic_link_black_24dp)!!.apply {
